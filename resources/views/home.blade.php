    ...
    <style>
        *, *::before, *::after { box-sizing: border-box; }
        ...
        .section-header {
            ...
            align-items: center; text-align: center; margin-bottom: 3rem;
        }
        .section-eyebrow {
    ...
    <main class="relative z-10 min-h-screen flex flex-col justify-center px-6 md:px-16 lg:px-28 pt-32 pb-24">
        ...
        <div class="fade-up delay-3 mt-7 max-w-xl"
             x-data="{
                 ...
                 sentenceIndex: 0, charIndex: 0, isDeleting: false, text: '',
                 typeSpeed: 20, deleteSpeed: 10, pauseEnd: 2500, pauseStart: 500,
                 init() { this.tick(); },
                 tick() {
                     let current = this.sentences[this.sentenceIndex];
                     if (this.isDeleting) { this.text = current.substring(0, this.charIndex - 1); this.charIndex--; }
                     else { this.text = current.substring(0, this.charIndex + 1); this.charIndex++; }
                     let delay = this.isDeleting ? this.deleteSpeed : this.typeSpeed;
                     if (!this.isDeleting && this.charIndex === current.length) { delay = this.pauseEnd; this.isDeleting = true; }
                     else if (this.isDeleting && this.charIndex === 0) { this.isDeleting = false; this.sentenceIndex = (this.sentenceIndex + 1) % this.sentences.length; delay = this.pauseStart; }
            ...
            <div class="relative z-10 flex flex-col md:flex-row-reverse items-center gap-10 md:gap-16">
                ...
                <div class="w-full md:w-3/5">
                    ...
                    <p class="text-white/50 leading-relaxed text-base mb-7">
                        As an Informatics Engineering Student, I bridge the gap between robust backend logic and captivating frontend experiences. I specialize in building clean, performant, and user-centered web applications.
                    </p>
                    <p class="text-white/50 leading-relaxed text-base mb-7">
